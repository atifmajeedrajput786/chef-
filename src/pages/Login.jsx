...
import rememberTick from '../assets/img/Remember-Tick.svg'
...
export default function Login() {
  ...
  return (
    <>
      ...
      <section className="header LoginHead">
          ...
          <div className="LoginPage">
            <div className="loginBox">
              ...
              <form className="BoxForm" onSubmit={handleSubmit}>
                ...
                <div className="RememberContant">
                  <button
                    type="button"
                    className={`Remember${remember ? ' active' : ''}`}
                    onClick={() => setRemember((r) => !r)}
                  >
                    <img src={rememberTick} alt="" />
